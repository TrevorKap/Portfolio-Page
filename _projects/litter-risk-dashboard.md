...
A dashboard that models and visualizes litter risk across an area, using machine learning to flag hotspots for cleanup and prevention efforts.

[View the dashboard](https://xxiaofan-98.github.io/Litter-risk-dashboard/)
